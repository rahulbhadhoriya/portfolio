...
const SocialIcons = (props, context) => {
  ...
  return (
    <div className="social-icons animate-icons">
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/rahulbhadhoriya" style={ { color: colorPrimary } }><i className="fab fa-github"></i></a>
        <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/RahulBhadhoriya" style={ { color: colorPrimary } }><i className="fab fa-twitter"></i></a>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/rahul-singh-bhadhoriya-66644996/" style={ { color: colorPrimary } }><i className="fab fa-linkedin"></i></a>
        <a target="_blank" rel="noopener noreferrer" href="https://medium.com/@RahulBhadhoriya" style={ { color: colorPrimary } }><i className="fab fa-medium"></i></a>
